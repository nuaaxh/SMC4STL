...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            if ((args.length == 1) && (args[0].equals("-h") || args[0].equals("--h") || args[0].equals("-help") || args[0].equals("--help"))) {
                System.out.println("Usage:  java -jar SMC4STL-<version>.jar <confidence_interval> <directory_of_csv_traces> <property_to_check>");
